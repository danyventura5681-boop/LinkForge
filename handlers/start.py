...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ===========================================
        ...
        if not links:
            text = "🔗 **No tienes ningún link registrado.**\n\n📝 Haz clic en el botón 'Registrar Link' o escribe /register para comenzar."
        else:
            main_link = links[0]
            ...
            text = (
                ...
                f"✏️ Para cambiarlo, usa el botón 'Cambiar Link'.\n"
        ...
        text = (
            "✏️ **Cambiar link**\n\n"
            "📝 Usa el botón 'Registrar Link' y envía tu nuevo link.\n\n"
        ...
        # NUEVO: Inicia modo conversación para registrar link
        ...
        if vip_level == 0:
            ...
            # Iniciar modo conversación para agregar link (VIP)
            from handlers.link import register_start
            await register_start(update, context)
